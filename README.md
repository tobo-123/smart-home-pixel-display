...
7. Connect the ESP8266 to your PC with the micro USB cable. Press the button on your BSH controller (the middle and right LED of your controller should flash now) and upload and run the program code via the Arduino IDE. You should see each pixel area of your display flash once. If this does not happen, check whether you have connected the matrix panel correctly and used the correct GPIO pin of the ESP.
